  ...
  return (
    <header className="">
      <div className="flex items-center bg-amazon_blue flex-grow p-1 py-2 ">
        ...
        <div
          className="
        hidden sm:flex items-center h-10 rounded-md bg-yellow-400
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
          <div className="link ">
            <h1 className="">Hello Sky</h1>
            <h1 className="font-extrabold md:text-sm">Accounts & Settings</h1>
          </div>
          <div className="link">
            <p className="">Returns</p>
            <h1 className="font-extrabold md:text-sm">& Orders</h1>
          </div>
